...
# We store the value of each time (total repeatting time is 100) the number of plays for a series in a list, and then calculate the average of the sum of these values. We receive a number of (about) 218. 
