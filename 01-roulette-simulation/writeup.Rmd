...
hist(walk_out_money, breaks = 100, xlab = "Walk Out Money in Dollars", ylab = "Frequency", main = "Distribution of Earnings When the Initial Budget is $200")
```
...
plot(one_series()[1:10], type = "b",  xlab="play number", ylab="earnings")
```
...
plot(list,xlab="Different Winnings Threshold for Stopping Values", ylab="Average Earnings",type = "b")
